...
const Page2 = () => {
  ...
  return (
    ...
    <div id='section2' className='bg-white text-center p-10'>
        <h3 className='text-gray-500 text-4xl font-[anzo5]'>©  anzo.studio 2024 | designed and developed</h3>
        <div>
        
       <div className='text-center rotateText'> 
       <h1 className='text-[35vw] uppercase leading-[30vw] text-black font-[anzo6] '>ISTE SFIT</h1>
       </div>
       <div  className='rotateText text-center  mt-36'> <h1 className='text-[35vw]   uppercase leading-[30vw] text-black font-[anzo6] '>BE</h1>
       </div>

       <div className=' rotateText text-center'> <h1 className='text-[35vw]  uppercase leading-[30vw] text-black font-[anzo6] '>THE</h1>
       </div>
       <div className='text-center rotateText'> <h1 className='text-[35vw] uppercase leading-[30vw] text-black font-[anzo6] '>PART</h1>
       </div>
       <div className='text-center rotateText'> <h1 className='text-[35vw] uppercase leading-[30vw] text-black font-[anzo6] '>OF THE</h1>
       </div>
       <div className='text-center rotateText'> <h1 className='text-[35vw] uppercase leading-[30vw] text-black font-[anzo6] '>LEGACY.</h1>
       </div>

       </div>
       <div className='flex items-center scale-50 mt-20 justify-center'>
    ...
    <g>
       ...
       <div className='h-1 w-1/3 relative left-1/2 mt-10 -translate-x-1/2 bg-black '>
